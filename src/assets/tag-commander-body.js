 ...
 * Generated: 2018-05-25 12:00:21 Europe/Paris
 * ---
 * Version	: 1.00
 * IDTC 	: 12
 * IDS		: 4056
...
tC.containersLaunched[4056][12] = {v:'1.00', t:[]};
...
tC.extend({
     ...
     */
    hitCounter_4056_12 : function() {
        if(Math.floor(Math.random()*parseInt(tC_4056_12.frequency)) == 0){
            tC.pixelTrack.add("//manager.tagcommander.com/utils/hit.php?id="+tC_4056_12.id_container+"&site="+tC_4056_12.id_site+"&version="+tC_4056_12.containerVersion+"&frequency="+tC_4056_12.frequency+"&position="+tC.container_position+"&rand="+Math.random());
        }
    }
});
...
tC.containerList.push("4056_12");
tC.onDomReady(function() {
    tC.container_4056_12.eventlisteners();
});
window.tc_array_events = tC.container_4056_12.init_tc_array_events([]);
...
tC.container_4056_12.datalayer();
...
tC.array_launched_tags=[];tC.array_launched_tags_keys=[];tC.id_site='4056';if(tC.getCookie('tc_mode_test')==1){(function(){var tc_testmodescriptload=document.createElement('script');tc_testmodescriptload.type='text/javascript';tc_testmodescriptload.src='//manager.tagcommander.com/utils/test_mode_include.php?id=12&site=4056&type=load&rand='+Math.random()+'&version=';(document.getElementsByTagName('body')[0]||document.getElementsByTagName('head')[0]||document.getElementsByTagName('script')[0].parentNode).appendChild(tc_testmodescriptload);})();}else{
/*VARIABLES_BLOCK*/
...
if(tC.getCookie('tc_mode_test')==1){(function(){var tc_testmodescriptexec=document.createElement('script');tc_testmodescriptexec.type='text/javascript';tc_testmodescriptexec.src='//manager.tagcommander.com/utils/test_mode_include.php?id=12&site=4056&type=exec&rand='+Math.random()+'&version=1.00';(document.getElementsByTagName('body')[0]||document.getElementsByTagName('head')[0]||document.getElementsByTagName('script')[0].parentNode).appendChild(tc_testmodescriptexec);})();(function(){setTimeout(function(){if(typeof top.tc_count!=='undefined'){top.tc_count++;}else{top.tc_count=1;}var tc_newscript=document.createElement('script');tc_newscript.type='text/javascript';tc_newscript.src='//manager.tagcommander.com/utils/livetest/bookmarklet.php?r='+Math.random()+'&nb='+top.tc_count+'&container=4056!12&version=1.00';(document.getElementsByTagName('body')[0]||document.getElementsByTagName('head')[0]||document.getElementsByTagName('script')[0].parentNode).appendChild(tc_newscript);},1000);})();}else{tC.launchTag(60,'Universal Analytics (builder)',1731,4056,12,14);(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');ga('create',"4668746",'auto');ga('send','pageview');tC.extend({executeTag60_4056_12:function(el,p){if(typeof p=="undefined"){p={};}
tc_array_events=tC.container_4056_12.init_tc_array_events(p);(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');ga('create',"4668746",'auto');ga('send','pageview');}});}